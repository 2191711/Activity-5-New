...
public class MixedFraction extends Fraction {
	...
	*/
        private int whole;
        private Fraction fraction = new Fraction(getNumerator(), getDenominator());
		/**
	...
	*/
        public void setWholePart(int whole) {this.whole = whole;}
/**
	* setter
	@param fraction as fraction
	*/
        public void setFractionPart(Fraction fraction) {this.fraction = fraction;}
/**
	* getter
	...
	*/
        public Fraction getFractionPart() { return this.fraction;
        }
		/**
